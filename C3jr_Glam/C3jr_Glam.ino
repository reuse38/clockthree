...
Mode NormalMode = {NORMAL_MODE, 
		   ...
		   Normal_inc, Normal_dec, Normal_mode, Normal_enter};
...
void setup(void){
  ...
  // MsTimer2::set(1000, tick_interrupt); // 1ms period // Turn off ticks for glam shots
  // MsTimer2::start();
...
void Normal_loop(void) {
  ...
  time_t spm = ((time_t)hh) * 3600 + mm * 60;
